...
public:
    ...
    bool isNull() const;
    bool hasValidSignature1(const QList<QSslCertificate> &issuer) const;
    bool hasValidSignature2(const QList<QSslCertificate> &issuer) const;
    bool hasValidSignature3(const QSslCertificate &issuer) const;
