...
DEFINEFUNC(OCSP_REQUEST *, OCSP_REQUEST_new, void, DUMMYARG, return 0, return)
DEFINEFUNC(void, OCSP_REQUEST_free, OCSP_REQUEST *a, a, return, DUMMYARG)
DEFINEFUNC3(OCSP_CERTID *, OCSP_cert_to_id, const EVP_MD *dgstd, dgstd, X509 *subject, subject, X509 *issuer, issuer, return 0, return)
DEFINEFUNC2(OCSP_ONEREQ *, OCSP_request_add0_id, OCSP_REQUEST *req, req, OCSP_CERTID *cid, cid, return 0, return)
...
DEFINEFUNC(OCSP_BASICRESP *, OCSP_response_get1_basic, OCSP_RESPONSE *resp, resp, return 0, return)
DEFINEFUNC(void, OCSP_RESPONSE_free, OCSP_RESPONSE *a, a, return, DUMMYARG)
DEFINEFUNC(void, OCSP_BASICRESP_free, OCSP_BASICRESP *a, a, return, DUMMYARG)
DEFINEFUNC7(int, OCSP_resp_find_status, OCSP_BASICRESP *a, a, OCSP_CERTID *b, b, int *c, c, int *d, d, ASN1_GENERALIZEDTIME **e, e, ASN1_GENERALIZEDTIME **f, f, ASN1_GENERALIZEDTIME **g, g, return -1, return )
DEFINEFUNC4(int, OCSP_check_validity, ASN1_GENERALIZEDTIME *a, a, ASN1_GENERALIZEDTIME *b, b, int c, c, int d, d, return -1, return)
DEFINEFUNC3(int, OCSP_request_add1_nonce, OCSP_REQUEST *a, a, unsigned char *b, b, int c, c, return -1, return)
DEFINEFUNC2(int, OCSP_check_nonce, OCSP_REQUEST *a, a, OCSP_BASICRESP *b, b, return -1, return)
DEFINEFUNC4(int, OCSP_basic_verify, OCSP_BASICRESP *a, a, STACK_OF(X509) *b, b, X509_STORE *c, c, unsigned long d, d, return -1, return)
...
bool q_resolveOpenSslSymbols()
{
    ...
    RESOLVEFUNC(OCSP_REQUEST_new)
    RESOLVEFUNC(OCSP_REQUEST_free)
    RESOLVEFUNC(OCSP_cert_to_id)
    RESOLVEFUNC(OCSP_request_add0_id)
    RESOLVEFUNC(ASN1_i2d_bio)
    RESOLVEFUNC(i2d_OCSP_REQUEST)
    RESOLVEFUNC(ASN1_d2i_bio)
    RESOLVEFUNC(OCSP_RESPONSE_new)
    ...
    RESOLVEFUNC(OCSP_resp_find_status)
    RESOLVEFUNC(OCSP_check_validity)
    RESOLVEFUNC(OCSP_request_add1_nonce)
    RESOLVEFUNC(OCSP_check_nonce)
